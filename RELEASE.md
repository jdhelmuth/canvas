...
- Keep automatic signing enabled and verify that the `com.johnhelmuth.canvas` App ID has WeatherKit configured.
...
- Verify settings, schedules, local audio, weather/AQI opt-in, denied-permission states, and offline behavior.
